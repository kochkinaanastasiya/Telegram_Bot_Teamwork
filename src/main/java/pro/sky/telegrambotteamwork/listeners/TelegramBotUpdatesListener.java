...
public class TelegramBotUpdatesListener implements UpdatesListener {
    ...
    /**
     * Этот метод даёт обратную связь с волонтером по собакам и отправкой запроса на получение статуса волонтера
     *
     * @param update входящее обновление
     */
    ...
    /**
     * Этот метод даёт обратную связь с волонтером по кошкам и отправкой запроса на получение статуса волонтера
     *
     * @param update входящее обновление
     */
